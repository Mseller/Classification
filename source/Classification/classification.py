...
parser.add_argument(
    '--model_dir', type=str, default='/Users/martinseller/Documents/Programing/Python/Classification/tmp/census_model',
...
parser.add_argument(
    '--train_data', type=str, default='/Users/martinseller/Documents/Programing/Python/Classification/tmp/census_data/adult.data.csv',
    help='Path to the training data.')

parser.add_argument(
    '--test_data', type=str, default='/Users/martinseller/Documents/Programing/Python/Classification/tmp/census_data/adult.test.csv',
...
def input_fn(data_file, num_epochs, shuffle, batch_size):
    ...
    def parse_csv(value):
        ...
        return features, tf.equal(labels, '>50')                                # Retuns all the features (minus the
